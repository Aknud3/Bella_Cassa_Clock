...
DICTIONARY = [
    {
        0: [26, 27, 28, 29, 30, 31, 32], 1: [6, 7, 8, 9, 10], 2: [19, 20, 21],
        3: [37, 38, 39], 4: [55, 56, 57, 58, 59], 5: [16, 17, 18],
        6: [40, 41, 42, 43], 7: [22, 23, 24, 25], 8: [44, 45, 46],
        9: [11, 12, 13, 14, 15], 10: [33, 34, 35, 36, 37], 11: [47, 48, 49, 50, 51, 52, 53],
        12: [26, 27, 28, 29, 30, 31, 32], 13: [6, 7, 8, 9, 10], 14: [19, 20, 21],
        15: [37, 38, 39], 16: [55, 56, 57, 58, 59], 17: [16, 17, 18],
        18: [40, 41, 42, 43], 19: [22, 23, 24, 25], 20: [44, 45, 46],
        21: [11, 12, 13, 14, 15], 22: [33, 34, 35, 36, 37], 23: [47, 48, 49, 50, 51, 52, 53],
        24: [26, 27, 28, 29, 30, 31, 32]
    },
    {
        0: [], 5: [84, 85, 86, 87, 107, 108, 109], 10: [61, 62, 63, 64, 65],
        15: [77, 78, 79, 80, 81, 82, 83], 20: [66, 67, 68, 69, 70, 71],
        25: [66, 67, 68, 69, 70, 71, 107, 108, 109],
        30: [71, 72, 73, 74, 75, 76], 35: [71, 72, 73, 74, 75, 76, 107, 108, 109, 110],
        40: [91, 92, 93, 94, 95, 96, 97],  45: [91, 92, 93, 94, 95, 96, 97, 107, 108, 109],
        50: [99, 100, 101, 102, 103, 104, 105],
        55: [99, 100, 101, 102, 103, 104, 105, 107, 108, 109]
    }
]

FIVE = ((14,15,16), (61, 62, 63, 64, 65), (37, 38, 39), (11, 12, 13), (6, 7, 8, 9, 10))
TEN = ((39, 40, 41, 42, 43), (17, 18, 19, 20, 21), (44, 45, 46), (11, 12, 13), (33, 34, 35, 36))
FIFTEEN = ((81, 82, 83, 84, 85, 86, 87), (55, 56, 58, 80, 81, 82, 83),
           (37, 38, 39, 80, 81, 82, 83), (26, 27, 28, 29, 30, 31, 32),
...
def clock_mode():
    ...
    clock_dots = [False] * 4
    for j in range(1,5):
        if minutes in [0+j,5+j, 10+j, 15+j, 20+j, 25+j, 30+j, 35+j, 40+j, 45+j, 50+j, 55+j]:
            for k in range(j):
                clock_dots[k] = True
    minutes = (minutes//5)*5
    filtered_clock_text = set(DICTIONARY[0].get(hours, []) + DICTIONARY[1].get(minutes, []))
        ...
        if BUTTON.value() == 0:
            ...
            while True:
                ...
                if BUTTON.value() == 0:
                    ...
                    break
            break
        if (i in [14, 29, 44, 59]) and any(i == (14 + 15 * j) for j, dot in enumerate(dots) if dot):
